...
const ContentDetails = ({route}) => {
  ...
  useEffect(() => {
    const nextExamIndex = reviewquestionsets.findIndex(
      (item, index) =>
        index > 0 &&
        reviewquestionsets[index - 1].studentdata[0]?.percentage >= 90,
    );
                          ...
                          <TouchableOpacity
                            ...
                            onPress={async () => {
                              navigation.navigate('MockTests', {
                                ...
                                topic: topic,
                                islastexercise:
                                  allIndexesContain90Percent && isLastItem
                                    ? true
                                    : false,
